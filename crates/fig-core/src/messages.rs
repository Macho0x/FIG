...
//!
//! These are manually defined structs that mirror the FTL schema in
//! schemas/orders.usl. In production, these would be generated by
//! the FTL codegen tool (fig-usl). For the skeleton demo, we
...
/// These match the well_known_id in the FTL schema.
pub mod schema_id {
