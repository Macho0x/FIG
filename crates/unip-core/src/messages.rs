//! Hardcoded message types for the UNIP exchange simulator.
//!
//! These are manually defined structs that mirror the USL schema in
//! schemas/orders.usl. In production, these would be generated by
//! the USL codegen tool (unip-usl). For the skeleton demo, we
...
/// These match the well_known_id in the USL schema.
pub mod schema_id {
